...
namespace Avalonia.MusicStore.Models
{
    public class Album
    {
        ...
        static iTunesSearchManager _searchManager = new iTunesSearchManager();
        ...
        string CachePath => $"./Cache/{Artist} - {Title}";
        ...
        static async Task SaveToStreamAsync(Album data, Stream stream)
        {
